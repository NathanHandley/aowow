...
//      'noTarget'      => "To others without a target",
    ...
    'npc' => array(
        ...
        // EQWOW end
        // EQWOW begin - triggered reactions (kill / gossip / quest spawns)
        'reactions'         => "Triggered Reactions",
        'reactTriggers'     => "This NPC triggers",
        'reactTriggeredBy'  => "This NPC is spawned or removed by",
        'reactThisNpc'      => "this NPC",
        'reactUnknownNpc'   => "an unknown NPC",
        'reactUnknownQuest' => "an unknown quest",
        // trigger headers - "Other" variants are used on the target's page, where the subject is the other NPC
        'reactOnDeath'      => "When killed",
        'reactOnDeathOther' => "when it is killed",
        'reactOnCombat'     => "When it enters combat",
        'reactOnCombatOther'=> "when it enters combat",
        'reactOnEvade'      => "When it leaves combat",
        'reactOnEvadeOther' => "when it leaves combat",
        'reactOnOocTimer'   => "After %s out of combat",
        'reactOnOocTimerOther' => "after %s out of combat",
        // actions
        'reactSpawns'       => "spawns %s",
        'reactSpawnsAtCorpse' => "spawns %s at its corpse",
        'reactSpawnsUnique' => "spawns %s, unless one is already up",
        'reactDespawns'     => "despawns %s",
        'reactDespawnsSelf' => "despawns itself",
        'reactRespawnsSelf' => "respawns itself at its own spawn point",
        'reactRespawnsTarget' => "makes %s respawn",
        'reactAttacks'      => "sends %s after the player",
        'reactAttacksSelf'  => "attacks the player",
        'reactSays'         => "says %s",
        'reactYells'        => "yells %s",
        'reactEmotes'       => "emotes %s",
        'reactSaysSomething'=> "says a line of text",
        'reactYellsSomething' => "yells a line of text",
        'reactEmotesSomething' => "plays an emote",
        'reactWalksTo'      => "walks to another spot, and on arrival",
        'reactArmsKillSpawn'=> "arms a trap: killing the questgiver afterwards spawns %s",
        'reactOneOf'        => "one of the following, picked at random",
        'reactCopies'       => "%d&times; %s",
        // notes
        'reactChance'       => "%s chance",
        'reactAfterDelay'   => "after %s",
        'reactAfterDelayRange' => "after %s to %s",
        'reactRespawnTime'  => "respawn timer: %s",
        'reactOnlyIfNotAlive' => "only while %s is not up",
        'reactRequireDead'  => "only if these are dead: %s",
        'reactRequireAlive' => "only if these are alive: %s",
        'reactLevelRange'   => "only at level %d-%d",
        'reactLevelMin'     => "only at level %d and above",
        'reactLevelMax'     => "only at level %d and below",
        'reactAddToHate'    => "starts hostile toward the killer",
        // gossip
        'gossip'            => "Gossip",
        'gossipDesc'        => "Talking to this NPC opens the following menu",
        'reactOnArrival'    => "when the walk ends",
        'gossipSpawnedBy'   => "This NPC is spawned or removed through gossip on",
        'gossipVia'         => "%s &ndash; option %s",
        // quest reactions
        'reactQuests'       => "Quest Reactions",
        'reactQuestsDesc'   => "Turning in these quests spawns or removes this NPC",
        'reactQuestsGiver'  => "Turning in these quests to this NPC makes it react",
        'reactQuestTurnIn'  => "On turn-in to %s",
        // EQWOW end
        'tameable'      => "Tameable (%s)",
    ...
    'quest' => array(
        ...
        // EQWOW begin - reactions fired by the questgiver on turn-in (mod_everquest_quest_reaction)
        'reactions'     => "On Turn-In",
        'reactionsDesc' => "Handing this quest in makes the questgiver react",
        // EQWOW end
        'progress'      => "Progress",
        'provided'      => "Provided",
...
/* -316*/   'Underwater Walking',                   'Periodic Haste'
    ...
    'item' => array(
        ...
        'itemOrigin'    => "Game of origin",                // EQWOW
        'eqOrigin'      => [null, "EverQuest", "World of Warcraft"], // EQWOW - indexes match filter values 1 / 2
